...
traindataset = TripletCOCOdatabase('/home/mcv/datasets/COCO/train2014','/home/mcv/datasets/COCO/instances_train2014.json','/home/mcv/datasets/COCO/mcv_image_retrieval_annotations.json',transform, "test", '/home/mcv/datasets/COCO/val2014')



testdataset = TripletCOCOdatabase('/home/mcv/datasets/COCO/val2014','/home/mcv/datasets/COCO/instances_val2014.json','/home/mcv/datasets/COCO/mcv_image_retrieval_annotations.json',transform, "test", '/home/mcv/datasets/COCO/val2014')
...
testLoader = DataLoader(traindataset, batch_size=32, shuffle=True)
...
torch.save(model,'/ghome/group06/m5/w4/weights.pth')
...
plt.savefig("losstripletEEE.png")
